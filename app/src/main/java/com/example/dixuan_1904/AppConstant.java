...
public interface AppConstant {
    ...
    public interface RequestParamsKey{
        ...
        String NEWS_START = "start";// 非视频类新闻
        String VIDEO_START = "video_start";// 视频类新闻
    ...
    String [] SHOULD_LOGIN_URL = {RequestUrl.DETAIL_DO_ARTICLE_LIKE, RequestUrl.DETAIL_DO_ARTICLE_COLLECT, RequestUrl.DETAIL_COMMENT_ARTICLE, RequestUrl.DETAIL_REPLY_COMMENT};
